 ...
 */
  ...
  <body>
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="<?php echo web_root; ?>">TanggapTrabahos</a>
  ...
  ?>
    ...
    <footer class="ftco-footer ftco-section" style="background-color: #424347">
      <div class="container">
        <div class="row mb-5">
        	<div class="col-md">
             <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">About</h2>
              <p>Tanggap Tabaho  is an Web based Hiring System.This system will help the Blue Collars to make their work will be easier  and  for the employers they will be able to used our system too seek for a workers.</p>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">Tayug Pangasinan Philippines</span></li>

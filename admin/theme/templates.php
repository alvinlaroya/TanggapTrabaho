...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo web_root;?>/admin/" class="logo">
      ...
      <span class="logo-lg"><b>TanggapTrabaho</b></span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu" style="padding-right: 15px;"  >
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="../user/avatar.png" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $singleuser->FULLNAME; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header"> 
                <img data-target="#menuModal"  data-toggle="modal"  src="../user/avatar.png" class="img-circle" alt="User Image" />  
              </li> 
              <!-- Menu Footer-->
 ...
 <div class="modal fade" id="menuModal" tabindex="-1">
      ...
      <ul class="sidebar-menu"> 
        ...
        <li class="<?php echo (currentpage() == 'company') ? "active" : false;?>" >
          <a href="<?php echo web_root ;?>admin/company/">
            <i class="fa fa-building"></i> <span>Company/Establishment</span> 
          </a>
        </li>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2022 <a href="#">TanggapTrabaho</a>.</strong> All rights
    reserved.
  </footer>
